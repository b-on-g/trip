...
declare namespace $ {
	...
	type $mol_number__hint_bog_vmap_part_calc_1 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_number['hint'] >
	>
	type $mol_number__value_bog_vmap_part_calc_2 = $mol_type_enforce<
		ReturnType< $bog_vmap_part_calc['left'] >
		,
		ReturnType< $mol_number['value'] >
	>
	type $mol_switch__value_bog_vmap_part_calc_3 = $mol_type_enforce<
		ReturnType< $bog_vmap_part_calc['op'] >
		,
		ReturnType< $mol_switch['value'] >
	>
	type $mol_switch__options_bog_vmap_part_calc_4 = $mol_type_enforce<
		({ 
			'add': string,
			'sub': string,
			'mul': string,
	...
	>
	type $mol_number__hint_bog_vmap_part_calc_5 = $mol_type_enforce<
		string
		,
		ReturnType< $mol_number['hint'] >
	>
	type $mol_number__value_bog_vmap_part_calc_6 = $mol_type_enforce<
		ReturnType< $bog_vmap_part_calc['right'] >
		,
		ReturnType< $mol_number['value'] >
	>
	type $mol_view__sub_bog_vmap_part_calc_7 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_vmap_part_calc_8 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	export class $bog_vmap_part_calc extends $mol_view {
		Left( ): $mol_number
		Op( ): $mol_switch
		Right( ): $mol_number
		Equals( ): $mol_view
...
declare namespace $ {
	...
	type $mol_view__sub_bog_vmap_part_plot_1 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_plot_line__series_x_bog_vmap_part_plot_2 = $mol_type_enforce<
		ReturnType< $bog_vmap_part_plot['series_x'] >
		,
		ReturnType< $mol_plot_line['series_x'] >
	>
	type $mol_plot_line__series_y_bog_vmap_part_plot_3 = $mol_type_enforce<
		ReturnType< $bog_vmap_part_plot['values'] >
		,
		ReturnType< $mol_plot_line['series_y'] >
	>
	type $mol_plot_line__color_bog_vmap_part_plot_4 = $mol_type_enforce<
		ReturnType< $bog_vmap_part_plot['color'] >
		,
		ReturnType< $mol_plot_line['color'] >
	>
	type $mol_plot_line__title_bog_vmap_part_plot_5 = $mol_type_enforce<
		ReturnType< $bog_vmap_part_plot['title'] >
		,
		ReturnType< $mol_plot_line['title'] >
	>
	type $mol_chart__graphs_bog_vmap_part_plot_6 = $mol_type_enforce<
		readonly($mol_plot_graph)[]
		,
		ReturnType< $mol_chart['graphs'] >
	>
	export class $bog_vmap_part_plot extends $mol_view {
		Title( ): $mol_view
		series_x( ): readonly(number)[]
		Line( ): $mol_plot_line
		Chart( ): $mol_chart
...
declare namespace $ {
	...
	type $mol_vector_2d__bog_vmap_part_map_1 = $mol_type_enforce<
		[ number, number ]
		,
		ConstructorParameters< typeof $mol_vector_2d<number> >
	>
	type $mol_map_yandex__zoom_bog_vmap_part_map_2 = $mol_type_enforce<
		ReturnType< $bog_vmap_part_map['zoom_limited'] >
		,
		ReturnType< $mol_map_yandex['zoom'] >
	>
	type $mol_map_yandex__center_bog_vmap_part_map_3 = $mol_type_enforce<
		ReturnType< $bog_vmap_part_map['center'] >
		,
		ReturnType< $mol_map_yandex['center'] >
	>
	type $mol_map_yandex__objects_bog_vmap_part_map_4 = $mol_type_enforce<
		ReturnType< $bog_vmap_part_map['objects'] >
		,
		ReturnType< $mol_map_yandex['objects'] >
	>
	type $mol_map_yandex_mark__pos_bog_vmap_part_map_5 = $mol_type_enforce<
		ReturnType< $bog_vmap_part_map['center'] >
		,
		ReturnType< $mol_map_yandex_mark['pos'] >
	>
	type $mol_map_yandex_mark__title_bog_vmap_part_map_6 = $mol_type_enforce<
		ReturnType< $bog_vmap_part_map['marker'] >
		,
		ReturnType< $mol_map_yandex_mark['title'] >
	>
	type $mol_map_yandex_mark__hint_bog_vmap_part_map_7 = $mol_type_enforce<
		ReturnType< $bog_vmap_part_map['marker'] >
		,
		ReturnType< $mol_map_yandex_mark['hint'] >
	>
	export class $bog_vmap_part_map extends $mol_view {
...
declare namespace $.$$ {
    ...
    class $mol_text extends $.$mol_text {
        ...
        rows(): ($.$mol_paragraph | $mol_view | $.$mol_text_code | $.$mol_grid)[];
        param(): string;
...
declare namespace $.$$ {
    class $bog_trip extends $.$bog_trip {
        total(): string;
        days(): number[];
    }
}
