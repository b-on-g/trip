...
;
	...
	($mol_mem(($.$bog_trip.prototype), "Theme"));
        ...
        class $bog_trip extends $.$bog_trip {
            total() {
                ...
                if (!Number.isFinite(cost))
                    return "Заполни три поля — посчитаю стоимость";
            ...
            days() {
                ...
                for (let day = 1; day <= 5; day += 1)
                    out.push(Math.round(whole * day * 2) / 10);
                return out;
            }
        }
        $$.$bog_trip = $bog_trip;
...
var $;
(function ($) {
    $mol_style_attach("bog/trip/trip.view.css", "[bog_trip] {\n\tpadding: 1rem;\n\tgap: 0.5rem;\n}\n");
})($ || ($ = {}));
